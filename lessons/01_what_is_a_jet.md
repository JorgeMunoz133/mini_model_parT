...
Picture the CMS detector as a series of nested cylindrical layers, wrapped
around the pipe where protons collide. When a collision happens in the
middle, quarks and other particles shoot outward in all directions. A
single quark can't exist alone in nature for long - as it flies outward, it
drags a cloud of other particles along with it, the way a fast-moving truck
kicks up a spray of gravel and dust behind it on a dirt road. **That whole
spray, moving roughly together in one direction, is called a jet.**
